...
I am a Ph.D. student at the Physics Department of McGill University in the Nuclear Theory group. My research focuses on realistic and robust parameter inference using computationally-intensive models of heavy-ion collisions to quantify the understanding of Quantum ChromoDynamics. I am also interested in applying these techniques to other applications, such as guidance in the teaching laboratory.
...
I am a Ph.D. Candidate in the Nuclear Theory group at McGill under the supervision of [Charles Gale](http://www.physics.mcgill.ca/~gale/Charles_Gale/Charles_Gale.html). We are actively working on uncertainty quantification and Bayesian inference using state-of-the-art numerical models of hot and dense strongly-interacting matter. Bayesian techniques are increasingly employed in heavy ion collisions and we hope to provide the most realistic quantification of the properties of strongly-interacting matter with their corresponding uncertainty.
...
I am supported by a PGS-D Scholarship from the Natural Sciences and Engineering Research Council of Canada (NSERC). I am partially supported at McGill as a Graduate Teaching Assistant. I have worked with [Nikolas Provatas](http://www.physics.mcgill.ca/~provatas/.index.html) as a STEM Graduate Teaching Development Fellow, working to flip the classroom McGill's large Physics 102 course. This involves writing new and challenging questions for students to solve, providing clear solutions, and recording select problem solutions. Some of these are available as worked solutions on the [course YouTube page](https://www.youtube.com/channel/UC7mdpQpOZ0WP7I4ppoYU7-w).
