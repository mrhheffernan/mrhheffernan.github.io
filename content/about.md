...
- **Open source:** Author of [maxpro](https://github.com/mrhheffernan/maxpro) — a Rust crate and Python package for Bayesian max-projection design of experiments

## Selected publications

- M. Heffernan, C. Gale, S. Jeon, and J.-F. Paquet. "Early-times Yang-Mills dynamics and the characterization of strongly interacting matter with statistical learning." *arXiv preprint* 2306.09619 (2023). [arXiv](https://arxiv.org/abs/2306.09619)
- M. Heffernan, C. Gale, S. Jeon, and J.-F. Paquet. "Bayesian quantification of the quark-gluon plasma with non-Gaussianinae priors." *Phys. Rev. C* 109, 024912 (2024). [arXiv](https://arxiv.org/abs/2302.02866)
- For a full list, see my [academic page](/academic/) or [Google Scholar](https://scholar.google.com/citations?user=cYVEweEAAAAJ).
